...
<article id="webslides" class="vertical">
  ...
  <section>
    ...
    <div class="wrap">
      ...
      <p class="aligncenter">Pour faire votre propre album, remplissez ce <a href="https://docs.google.com/spreadsheets/d/1qoPNh_mkCbr15v8t3ys3I5LPGRrY9NVflVCE9ZYQmQU/edit?usp=sharing" target="_blank">template GDoc</a><br>et envoyez le à arthur[]thecamp.fr</p>
      <div class="grid">
        <div class="column">
